...
function ForProject() {
  ...
  return (
    <div className="w-full h-[70%] md:h-full relative flex flex-col rounded-lg justify-center items-center bg-[#CDEA68]">
      ...
      <Eyes num={1} className="top-1/4 md:top-1/2"/>
      <div className="md:mt-[4vw]">
        <button
          onMouseEnter={() => setIsHoveringforBTN(true)}
          onMouseLeave={() => setIsHoveringforBTN(false)}
          className="bg-zinc-700 z-[10] text-white hover:bg-zinc-900 transition-[all] duration-[0.5] ease-[cubic-bezier(0.85, 0, 0.15, 1)] px-4 py-2 w-[300px] rounded-full absolute bottom-[20%] md:bottom-[5vw] left-1/2 -translate-x-1/2"
        >
